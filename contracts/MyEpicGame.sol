...
contract MyEpicGame is ERC721 {
    ...
    function attackBoss() public {
        ...
        // We are getting a reference of the original NFT's attributes. (not copy) so when we change any of the attributes, it would change globally.
        ...
        require(bigBoss.hp > 0, "Boss has no HP left!");
